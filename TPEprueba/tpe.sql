...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2023 a las 20:06:05
...
(37, 'Virginia Woolf', 'Novelista', '2023-11-10'),
...
(31, ' Una habitación propia', 'Virginia Woolf trataba en sus obras temas como la locura y el feminismo.', 'Novela', 37),
...
--
ALTER TABLE `autores`
  MODIFY `Autor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT de la tabla `libros`
--
ALTER TABLE `libros`
  MODIFY `Libro_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
